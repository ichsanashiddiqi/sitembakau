			...
			<div class="row">
				...
				<div class="col-sm-3 col-lg-3">
					...
					<div style="margin-top: -5px;">
						<a href="<?php echo base_url('index.php/varietas/detailvarietas/').urlencode(strtolower($varietasSide->nama_varietas)); ?>" style="color:black;text-decoration-line: none;">
